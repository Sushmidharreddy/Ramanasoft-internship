...
import { carpet_validation, pincode_validation, property_value } from "./Regex";
...
function PropertyDetails() {
  ...
  const onChangeHandler = (e) => {
    ...
    if (name === "valueofproperty") {
      if (!property_value.test(val))
        setValidationError({
          ...validationError,
          [name]: "Property value should be greater than 100000",
        });
      else setValidationError({ ...validationError, [name]: "" });
    } else if (name === "carpetarea") {
      if (!carpet_validation.test(val))
        setValidationError({
          ...validationError,
          [name]: "Carpetarea should be greater than 100",
        });
      else {
  ...
  const SubmitHandler = (e) => {
    ...
    if (
      property_value.test(propertyDetails.valueofproperty) &&
      carpet_validation.test(propertyDetails.carpetarea) &&
      pincode_validation.test(propertyDetails.pincode)
    ) {
      navigate("/quotepage", { state: { propertyDetails } });
      e.preventDefault();
    }
  };
  ...
  useEffect(() => {
    ...
    const storedFormData = sessionStorage.getItem("propertyDetails");
    if (storedFormData) {
      setPropertyDetails(JSON.parse(storedFormData));
    }
  }, []);
  ...
  return (
    <>
      <div className="bg-dark text-center fw-bold text-light ">
        <h4 className="p-2 ">Property Details</h4>
      </div>
      ...
      <form className="container" onSubmit={SubmitHandler}>
        <header className="bg-info container rounded">
          <h4 className="px-3 py-1 fw-bold ">Structure Details</h4>
        </header>
          ...
          <table>
            <tbody>
              <tr>
                <td>
                  {" "}
                  <label htmlFor="valueofproperty" className="m-3 fw-bold">
                ...
                <td>
                  <input
                    ref={valueofpropertyRef}
                    type="text"
                    id="valueofproperty"
                    name="valueofproperty"
                    value={propertyDetails.valueofproperty}
                    onChange={onChangeHandler}
                    autoComplete="off"
                    className="p-1 rounded fw-bold"
                    placeholder="Min Rs.100000"
                    required
                  />
                  <br />
                  {validationError.valueofproperty && (
              ...
              <tr>
                <td>
                  <label htmlFor="carpetarea" className="m-3 fw-bold">
                    Carpet area (sqft):<span className="text-danger">*</span>
                  </label>
                </td>
                <td>
                  <input
                    ...
                    onChange={onChangeHandler}
                    autoComplete="off"
                    placeholder="Min100sqft"
                    className="p-1 rounded fw-bold"
                    required
                  />
                  <br />
                  {validationError.carpetarea && (
                    <span className="text-danger">
                      {validationError.carpetarea}
                    </span>
                  )}
              ...
              <tr>
                <td>
                  <label htmlFor="pincode" className="m-3 fw-bold">
                    {" "}
              ...
              <tr>
                <td>
                  <label htmlFor="ageofthebuilding" className="m-3 fw-bold">
                    Age of the Building:<span className="text-danger">*</span>
                  </label>
                </td>
                <td>
                  {" "}
                  <select
                    ...
                    value={propertyDetails.ageofthebuilding}
                    onChange={onChangeHandler}
                    className="p-1 rounded dropDownlen"
                    required
                  >
                    <option value="">select</option>
              ...
              <tr>
                <td>
                  <label htmlFor="disaster" className="m-3 fw-bold">
                    Has Your Property effected with floods/Earthquake in past
                    5years:<span className="text-danger">*</span>
                  </label>
                </td>
                <td>
                  {" "}
                  <select
                    id="disaster"
                    name="disaster"
                    value={propertyDetails.disaster}
                    onChange={onChangeHandler}
                    className="p-1 rounded dropDownlen"
                    required
                  >
                  ...
                  {selectedOption && (
                    <div className="popup ">
                      <div className="bg-light border border-1 border-dark rounded ">
          ...
          <table>
            <tbody>
              <tr>
                <td>
                  {" "}
                  <label htmlFor="securitycheck" className="m-3 fw-bold">
                    24*7 Security:<span className="text-danger">*</span>{" "}
                  </label>
                </td>
                ...
                <td>
                  <select
                    id="securitycheck"
                    name="securitycheck"
                    value={propertyDetails.securitycheck}
                    onChange={onChangeHandler}
                    className="p-1 rounded securitylen dropDownlen"             
                    required
                  >
                    <option value="">select</option>
              ...
              <tr>
                <td>
                  <label htmlFor="salaryStatus" className="m-3 fw-bold">
                    Are you salried individual?<span className="text-danger">*</span>
                  </label>
                </td>
                ...
                <td>
                  ...
                  <select
                    id="salaryStatus"
                    name="salaryStatus"
                    value={propertyDetails.salaryStatus}
                    onChange={onChangeHandler}
                    className="p-1 rounded securitylen dropDownlen"
                    required
                  >
        ...
        <div className="center-wrapper">
          <button className="btn btn-success px-3 m-3 ">Procced</button>
        </div>
      </form>
    </>
  );
